...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        display: ['var(--font-display)', 'ui-sans-serif', '-apple-system', 'BlinkMacSystemFont', 'sans-serif'],
        sans: ['var(--font-sans)', 'system-ui', '-apple-system', 'Segoe UI', 'sans-serif'],
        mono: ['var(--font-mono)', 'ui-monospace', 'SFMono-Regular', 'Menlo', 'monospace'],
        cute: ['var(--font-cute)', '"Comic Sans MS"', 'sans-serif'],
      },
      fontSize: {
        'display-xl': ['clamp(3.25rem, 7vw, 5.75rem)', { lineHeight: '0.98', letterSpacing: '-0.035em' }],
        'display-lg': ['clamp(2.5rem, 5vw, 4rem)',     { lineHeight: '1.02', letterSpacing: '-0.03em' }],
        'display-md': ['clamp(2rem, 3.6vw, 2.75rem)',  { lineHeight: '1.08', letterSpacing: '-0.025em' }],
      },
      borderRadius: {
