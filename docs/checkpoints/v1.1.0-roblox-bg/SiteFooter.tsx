  ...
  return (
    <footer className="mt-24 border-t border-creamShade bg-cream">
      <div className="container-soft py-14 grid gap-10 md:grid-cols-[1.4fr_1fr_1fr]">
        <div>
          <div className="display text-2xl text-cocoa leading-tight">
            EMGamer<span className="text-syrup">731</span>
          </div>
          <p className="display-italic text-cocoa/80 mt-2 max-w-md">
            "{SITE.slogan}"
          </p>
