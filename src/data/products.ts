...
export const PRODUCTS: Product[] = [
  ...
  { id: 'p003', slug: 'syrup-drip-zip-hoodie', name: 'Syrup Drip Zip Hoodie', collection: 'syrup-drip', category: 'hoodies', priceCents: 6200, description: 'Honey-amber zip with caramel drip embroidery on the chest.', hero: '/shop/hoodie-zip-syrup.svg', swatches: ['#E8A53C','#C97B3D'], sizes: ['XS','S','M','L','XL','2XL'], tags: ['premium','drip','syrup'], badge: 'new' },
  ...
  { id: 'p006', slug: 'morning-spawn-sweatpants', name: 'Morning Spawn Sweatpants', collection: 'morning-spawn', category: 'sweatpants', priceCents: 4400, description: 'Soft jogger fit with EMG731 hem tag and pocket waffle texture.', hero: '/shop/sweatpants-morning.svg', swatches: ['#3B2A22','#A8E6CF'], sizes: ['XS','S','M','L','XL','2XL'], tags: ['joggers','soft'] },
  ...
  // ----- Hats / accessories
  { id: 'p012', slug: 'avatar-callback-cap', name: 'Avatar Callback Black Cap', collection: 'eat-with-emm', category: 'hats', priceCents: 3200, description: 'Black 6-panel cap embroidered with "EMG731" — the iconic avatar callback.', hero: '/shop/cap-black-emg731.svg', swatches: ['#1F1611'], sizes: ['One Size'], tags: ['cap','avatar','signature'], badge: 'fan-fave', featured: true },
  ...
  { id: 'p041', slug: 'mint-breakfast-sweatpants', name: 'Mint Breakfast Sweatpants', collection: 'breakfast-boss', category: 'sweatpants', priceCents: 4800, description: 'Match the mint slogan hoodie. Heavyweight cotton blend, drawstring waist, side pockets.', hero: '/shop/sweatpants-mint-breakfast.svg', swatches: ['#A8E6CF'], sizes: ['XS','S','M','L','XL','2XL'], tags: ['sweatpants','mint','set'], badge: 'new', featured: true },
  { id: 'p042', slug: 'pink-waffle-sweatpants',    name: 'Pink Waffle Sweatpants',    collection: 'waffle-stack',  category: 'sweatpants', priceCents: 4800, description: 'Match the pink waffle hoodie. Soft brushed inside, drawstring waist.', hero: '/shop/sweatpants-pink-waffle.svg', swatches: ['#F4B7D6'], sizes: ['XS','S','M','L','XL','2XL'], tags: ['sweatpants','pink','set'], badge: 'new', featured: true },
  { id: 'p043', slug: 'cream-classic-sweatpants',  name: 'Cream Classic Sweatpants',  collection: 'cozy-breakfast-club', category: 'sweatpants', priceCents: 4800, description: 'Quiet-luxe cream sweats. Pairs with literally everything.', hero: '/shop/sweatpants-cream.svg', swatches: ['#F4ECDC'], sizes: ['XS','S','M','L','XL','2XL'], tags: ['sweatpants','cream'] },
  { id: 'p044', slug: 'mint-tapered-joggers',      name: 'Mint Tapered Joggers',      collection: 'morning-spawn', category: 'sweatpants', priceCents: 5200, description: 'Tapered fit with ribbed ankle cuffs. Stream-room ready.', hero: '/shop/joggers-mint-tapered.svg', swatches: ['#A8E6CF'], sizes: ['XS','S','M','L','XL','2XL'], tags: ['joggers','tapered','mint'], badge: 'new' },
  { id: 'p045', slug: 'pink-tapered-joggers',      name: 'Pink Tapered Joggers',      collection: 'waffle-stack',  category: 'sweatpants', priceCents: 5200, description: 'Tapered pink joggers with ribbed cuffs.', hero: '/shop/joggers-pink-tapered.svg', swatches: ['#F4B7D6'], sizes: ['XS','S','M','L','XL','2XL'], tags: ['joggers','tapered','pink'] },
  { id: 'p046', slug: 'cocoa-tapered-joggers',     name: 'Cocoa Tapered Joggers',     collection: 'morning-spawn', category: 'sweatpants', priceCents: 5200, description: 'Deep cocoa brown joggers — lounge-soft.', hero: '/shop/joggers-cocoa-tapered.svg', swatches: ['#3B2A22'], sizes: ['XS','S','M','L','XL','2XL'], tags: ['joggers','tapered','cocoa'] },
  { id: 'p047', slug: 'mint-breakfast-cap',        name: 'Mint Breakfast Dad Cap',    collection: 'breakfast-boss', category: 'hats', priceCents: 3200, description: 'Soft mint dad cap, embroidered "BREAKFAST" front.', hero: '/shop/cap-mint-breakfast.svg', swatches: ['#A8E6CF'], sizes: ['One Size'], tags: ['cap','dad-hat','mint'], badge: 'new' },
  { id: 'p048', slug: 'pink-waffle-cap',           name: 'Pink Waffle Dad Cap',       collection: 'waffle-stack',  category: 'hats', priceCents: 3200, description: 'Soft pink dad cap, embroidered "WAFFLE" front.', hero: '/shop/cap-pink-waffle.svg', swatches: ['#F4B7D6'], sizes: ['One Size'], tags: ['cap','dad-hat','pink'], badge: 'new' },
  { id: 'p049', slug: 'cream-emg-cap',             name: 'Cream EMG Cap',             collection: 'eat-with-emm',  category: 'hats', priceCents: 3200, description: 'Cream cap with cocoa "EMG" embroidery.', hero: '/shop/cap-cream-emg.svg', swatches: ['#F4ECDC'], sizes: ['One Size'], tags: ['cap','dad-hat','cream'] },
  ...
  { id: 'p057', slug: 'cream-emg-classic-hoodie',  name: 'Cream EMG Classic Hoodie',  collection: 'eat-with-emm',  category: 'hoodies', priceCents: 5800, description: 'Cream hoodie with the EMG731 logo badge — quiet flex.', hero: '/shop/hoodie-cream-classic.svg', swatches: ['#F4ECDC'], sizes: ['XS','S','M','L','XL','2XL'], tags: ['hoodie','cream','classic'] },
  { id: 'p058', slug: 'lavender-cereal-hoodie',    name: 'Lavender Cereal Hoodie',    collection: 'cereal-chaos',  category: 'hoodies', priceCents: 5800, description: 'Lavender hoodie — Cereal Chaos colorway.', hero: '/shop/hoodie-lavender-cereal.svg', swatches: ['#E2D6FF'], sizes: ['XS','S','M','L','XL','2XL'], tags: ['hoodie','lavender'] },
  { id: 'p059', slug: 'butter-pancake-hoodie',     name: 'Butter Pancake Hoodie',     collection: 'pancake-power-up', category: 'hoodies', priceCents: 5800, description: 'Butter yellow pullover with pancake stack graphic.', hero: '/shop/hoodie-butter-pancake.svg', swatches: ['#FFD89C'], sizes: ['XS','S','M','L','XL','2XL'], tags: ['hoodie','pancake'] },
  { id: 'p060', slug: 'black-emg-hoodie',          name: 'Black EMG731 Hoodie',       collection: 'eat-with-emm',  category: 'hoodies', priceCents: 6200, description: 'Black hoodie with the cap-callback EMG731 wordmark in cream + amber.', hero: '/shop/hoodie-black-cap.svg', swatches: ['#1F1611'], sizes: ['XS','S','M','L','XL','2XL'], tags: ['hoodie','black','signature'], badge: 'new' },
];
